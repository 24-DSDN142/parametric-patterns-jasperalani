!function (e) {
    ...
    var r = function () {
        ...
        var n, t, r;
        return n = e, (t = [{
            key: "resolution", value: function (e) {
            ...
            key: "show_guide", value: function (e) {
                if (void 0 === e) return this._show_guide;
                this._show_guide = e
            }
        }, {
            key: "output_mode", value: function (e) {
    ...
    var a = new function () {
        ...
        window.DEVELOP_GLYPH = (n = e, function () {
            var e = n.grid_settings.cell_width, t = n.grid_settings.cell_height;
            ...
            return function () {
                var n = e.grid_settings.cell_width, t = e.grid_settings.cell_height, i = e.grid_settings.row_offset;
                push(), scale(e.resolution().scale);
                for (var o = -n; o < width + n; o += n) for (var r = 0, a = -t; a < height + t; a += t) {
                    var u = r % 2 == 0 ? 0 : i;
            ...
            return function () {
                ...
                push(), scale(e.resolution().scale);
                for (var r = 2 * -n; r < width + 2 * n; r += 2 * n) for (var a = -t; a < height + t; a += t) push(), translate(r, a), o(), translate(2 * n, i), scale(-1, 1), o(), pop();
                pop()
            }
            ...
            }), {x: window.innerWidth, y: window.innerHeight, scale: 1}
        }, window.NINE_LANDSCAPE = function () {
            return {x: 2e3, y: 1e3, scale: 1}
        }, window.NINE_PORTRAIT = function () {
            return {x: 1e3, y: 2e3, scale: 1}
        }, window.A4 = function () {
            return {x: 2480, y: 3508, scale: 300 / 72}
        }, window.A3 = function () {
            return {x: 3508, y: 4960, scale: 300 / 72}
        }
    }, l = new p5;
